...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    test_volume_of_cube_result = volume_of_cube( 3 )
    assert_equal( 27, test_volume_of_cube_result )
  end

  # #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    test_volume_of_sphere_result = volume_of_sphere( 1 )
    assert_equal( 4.19, test_volume_of_sphere_result )
  end
  #
